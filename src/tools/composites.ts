...
export function registerCompositeTools(server: McpServer, client: PropstackClient): void {
  ...
  server.registerTool(
    "full_contact_360",
    {
      title: "Full Contact 360",
      description: `Get a complete 360° view of a contact — everything you need before calling a client.
...
need the full picture: "Tell me everything about Herr Weber."`,
  ...
  server.registerTool(
    "property_performance_report",
    {
      ...
      description: `Performance report for a property — days on market, inquiry count,
...
Use when asked: "How is the Friedrichstr property doing?"`,
  ...
  server.registerTool(
    "pipeline_summary",
    {
      ...
      description: `Pipeline overview — deals per stage, total values, and stale deals
needing attention.
...
"How's the pipeline looking?" or "Give me a sales overview."`,
  ...
  server.registerTool(
    "smart_lead_intake",
    {
      ...
      description: `Complete lead intake workflow — dedup check, create/update contact,
...
Returns what was done: created vs updated, IDs of all created records.`,
  ...
  server.registerTool(
    "match_contacts_to_property",
    {
      title: "Match Contacts To Property",
      description: `Find contacts whose search profiles match a property. Returns a
