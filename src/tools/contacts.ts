...
export function registerContactTools(server: McpServer, client: PropstackClient): void {
  ...
  server.registerTool(
    "search_contacts",
    {
      ...
      description: `Search and filter contacts in Propstack CRM.
...
Use 'include' to load related data in one request.`,
  ...
  server.registerTool(
    "create_contact",
    {
      ...
      description: `Create a new contact in Propstack CRM.
...
Use get_contact_sources first to find valid source IDs.`,
  ...
  server.registerTool(
    "update_contact",
    {
      ...
      description: `Update an existing contact in Propstack CRM.
...
Only provide the fields you want to change.`,
  ...
  server.registerTool(
    "delete_contact",
    {
      ...
      description: `Delete a contact from Propstack CRM (soft delete).
...
- Cleaning up test data`,
  ...
  server.registerTool(
    "get_contact_sources",
    {
      title: "Get Contact Sources",
      description: `List all available contact/lead sources in Propstack.
...
contacts with client_source_id.`,
  ...
  server.registerTool(
    "search_contacts_by_phone",
    {
      title: "Search Contacts By Phone",
