...
export function registerLookupTools(server: McpServer, client: PropstackClient): void {
  ...
  server.registerTool(
    "list_pipelines",
    {
      ...
      description: `List all deal pipelines and their stages in Propstack.
...
Typical stages: Anfrage → Besichtigung → Reserviert → Notartermin → Verkauft.`,
  ...
  server.registerTool(
    ...
    {
      title: "Get Pipeline",
      description: `Get a single deal pipeline by ID with its stages.
...
already know which pipeline you need and want its stage details.`,
  ...
  server.registerTool(
    ...
    {
      title: "List Tags",
      description: `List all tags/labels (Merkmale/Gruppen) in Propstack.
...
try hierarchical view via /super_groups.`,
  ...
  server.registerTool(
    ...
    {
      title: "Create Tag",
      description: `Create a new tag/label (Merkmal) in Propstack.
...
Examples: "Penthouse-Käufer", "VIP", "Kapitalanleger", "Erstbezug".`,
  ...
  server.registerTool(
    "list_custom_fields",
    {
      ...
      description: `List custom field definitions for an entity type in Propstack.
...
To FILTER by custom fields: add cf_fieldname=value as a search param.`,
  ...
  server.registerTool(
    ...
    {
      title: "List Users",
      description: `List all brokers/agents (Nutzer) in the Propstack account.
...
- Assigning tasks and events`,
  ...
  server.registerTool(
    ...
    {
      title: "List Teams",
      description: `List all teams/departments in Propstack.
...
filtering and to understand the organizational structure.`,
  ...
  server.registerTool(
    "list_activity_types",
    {
      ...
      description: `List all activity/task types in Propstack.
...
for_events→event, message→message.`,
  ...
  server.registerTool(
    "list_contact_statuses",
    {
      ...
      description: `List contact statuses (Kontaktstatus) in Propstack.
...
(client_status_id). E.g. "Lead", "Kunde", "Archiviert".`,
  ...
  server.registerTool(
    "list_reservation_reasons",
    {
      title: "List Reservation Reasons",
      description: `List deal cancellation reasons (Reservierungsgründe/Absagegründe).
...
or filtering lost deals (search_deals reservation_reason_ids).`,
  ...
  server.registerTool(
    "list_locations",
    {
      ...
      description: `List geographic areas/districts (Geolagen) in Propstack.
