...
export function registerSearchProfileTools(server: McpServer, client: PropstackClient): void {
  ...
  server.registerTool(
    "list_search_profiles",
    {
      title: "List Search Profiles",
      description: `List search profiles (Suchprofile) in Propstack.
...
Filter by contact ID to answer "What is this buyer looking for?"`,
  ...
  server.registerTool(
    "create_search_profile",
    {
      ...
      description: `Create a search profile (Suchprofil) for a contact in Propstack.
...
Use radius search (lat/lng/radius) for "within 5km of Alexanderplatz".`,
  ...
  server.registerTool(
    "update_search_profile",
    {
      ...
      description: `Update an existing search profile in Propstack.
...
Only provide the fields you want to change.`,
  ...
  server.registerTool(
    "delete_search_profile",
    {
      ...
      description: `Delete a search profile from Propstack.
